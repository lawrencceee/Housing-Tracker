# 🏠 Dublin House Application Tracker (Notion Agent)
...
## 📁 Related Projects
Check out my [[Notion Job Tracker Agent](link)](https://github.com/lawrencceee/LangChain_notion_agent) for another LangChain-powered use case.
